...
$std.= "WORKDIR='/data/zhaolian/LineageTracing/DSS/PacBio/8.tree'\n";
$std.= "cd \$WORKDIR\n\n\n";
...
$std.= "### 执行程序\n";
$std.= "iqtree -T AUTO -s $SAMPLENAME.phy -o ref \n";
$std.= "###运行结束 \n\n";
...
system "qsub 8.run_iqtree_$SAMPLENAME.sh ";

#usage perl 8.iqtree_submit.pl 10 1 4N
#nohup iqtree -T 20 -s 16N.phy -o ref &
